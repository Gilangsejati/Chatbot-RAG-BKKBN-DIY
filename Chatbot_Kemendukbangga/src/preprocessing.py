...
class Preprocessor:
    ...
    @staticmethod
    def text_cleanup(text: Optional[str]) -> str:
        """
        Bersihkan teks:
         - pastikan string
         - unicode normalize
        ...
        # \w sudah mendukung unicode letters ketika re.UNICODE (default in Python 3)
    ...
    def preprocess(self) -> pd.DataFrame:
        ...
        self.df["combined_text"] = (
            self.df["question_clean"].fillna("") + " " + self.df["answer_clean"].fillna("")
        ).str.strip()
